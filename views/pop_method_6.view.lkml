...
view: order_items_method_6 {
  ...
  dimension: days_from_start_first {
    ...
    hidden: yes
    type: number
    sql: DATE_DIFF(${created_date}, DATE({% date_start first_period_filter %}, 'US/Eastern'), DAY) ;;
  }
  ...
  dimension: days_from_start_second {
    ...
    hidden: yes
    type: number
    sql: DATE_DIFF(${created_date}, DATE({% date_start second_period_filter %}, 'US/Eastern'), DAY) ;;
  }
